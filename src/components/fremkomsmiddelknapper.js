...
import { MdDirectionsWalk, MdDirectionsBike, MdTrain, MdDirectionsBus, MdDirectionsCar } from "react-icons/md"; // ikonene
...
export function ToggleButtonsFremkomstmiddel({middel, onChange}) {
    ...
    const radios = [
      ...
      { name: <MdTrain size={iconSize} />,            value: 'Tog' },
      { name: <MdDirectionsBus size={iconSize} />,    value: 'Buss' },
