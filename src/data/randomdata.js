...
function formatDate(date) { // funksjon som tar inn en dato og returnerer en string på formen YYYY-MM-DD
    var d = new Date(date)
    var month = '' + (d.getMonth() + 1) // måneder begynner med index 0
    var day = '' + d.getDate()
