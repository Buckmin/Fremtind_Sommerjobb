...
var jklTextInputReact = require('@fremtind/jkl-text-input-react');
var jklReactHooks = require('@fremtind/jkl-react-hooks');
var jklIconButtonReact = require('@fremtind/jkl-icon-button-react');
var CoreDatepicker = _interopDefault(require('@nrk/core-datepicker/jsx'));
var jklSelectReact = require('@fremtind/jkl-select-react');
...
var Calendar = React.forwardRef(function (_ref, ref) {
  ...
  return /*#__PURE__*/React__default.createElement(CoreDatepicker, {
  ...
  }, extended && /*#__PURE__*/React__default.createElement("div", {
    className: "jkl-calendar__navigation"
  }, /*#__PURE__*/React__default.createElement(jklTextInputReact.TextInput, {
    inverted: inverted,
    label: yearLabel,
    type: "year",
  ...
  }), /*#__PURE__*/React__default.createElement(jklSelectReact.NativeSelect, {
    inverted: inverted,
    ...
    variant: "small",
    forceCompact: forceCompact
  })), !extended && /*#__PURE__*/React__default.createElement("fieldset", {
...
function DatePicker(_ref) {
  ...
  var _useState = React.useState("jkl-datepicker-".concat(nanoid(8))),
      _useState2 = _slicedToArray(_useState, 1),
      inputId = _useState2[0];

  var _useState3 = React.useState("jkl-support-label-".concat(nanoid(8))),
      _useState4 = _slicedToArray(_useState3, 1),
      supportLabelId = _useState4[0];

  var _useState5 = React.useState(initialDate),
      _useState6 = _slicedToArray(_useState5, 2),
      date = _useState6[0],
      setDate = _useState6[1];

  var _useState7 = React.useState(!initialShow),
      _useState8 = _slicedToArray(_useState7, 2),
      calendarHidden = _useState8[0],
      setCalendarHidden = _useState8[1];

  var _useState9 = React.useState(initialDate ? formatDate(initialDate) : ""),
  ...
  var _useAnimatedHeight = jklReactHooks.useAnimatedHeight(!calendarHidden),
      _useAnimatedHeight2 = _slicedToArray(_useAnimatedHeight, 1),
      calendarRef = _useAnimatedHeight2[0];

  jklReactHooks.useClickOutside(calendarRef, function () {
    !calendarHidden && setCalendarHidden(true);
  });
  jklReactHooks.useKeyListener(calendarRef, ["Escape"], function () {
    !calendarHidden && setCalendarHidden(true);
  ...
  var toggleCalendarWithoutFocus = React.useCallback(function () {
  ...
  return /*#__PURE__*/React__default.createElement("div", {
  ...
  }, /*#__PURE__*/React__default.createElement(jklTextInputReact.BaseInputField, {
    ref: inputRef,
    id: inputId,
    ...
    width: "11.5rem"
  }), /*#__PURE__*/React__default.createElement(jklIconButtonReact.IconButton, {
  ...
  }, /*#__PURE__*/React__default.createElement(Calendar, _extends({
    currentDate: date,
    ...
    forceCompact: forceCompact,
    ref: calendarRef
  }, calendarProps)))), /*#__PURE__*/React__default.createElement(jklCore.SupportLabel, {
    inverted: inverted,
    id: supportLabelId,
    helpLabel: helpLabel,
