...
var Logo = function Logo(_ref) {
  var className = _ref.className,
      ...
      isSymbol = _ref.isSymbol,
      animated = _ref.animated,
      _ref$title = _ref.title,
      title = _ref$title === void 0 ? "Fremtind" : _ref$title;

  var _useState = React.useState("jkl-logo-".concat(nanoid(16))),
      _useState2 = _slicedToArray(_useState, 1),
      uniqueId = _useState2[0];

  var componentClassName = classnames("jkl-logo", className, {
  ...
  return /*#__PURE__*/React__default.createElement("div", {
    ...
    id: uniqueId
  }, title), /*#__PURE__*/React__default.createElement("g", {
    fill: "none",
    className: "jkl-logo__F",
    strokeWidth: "8",
    transform: "".concat(isSymbol ? "rotate(45) translate(90, -70)" : "")
  ...
  })), !(isSymbol && !animated) && /*#__PURE__*/React__default.createElement("path", {
    strokeWidth: ".57975",
