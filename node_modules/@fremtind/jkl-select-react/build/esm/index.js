...
import { getValuePair, Label, SupportLabel } from '@fremtind/jkl-core';
...
function Select(_ref) {
  ...
  var getLabelFromValue = useCallback(function (value) {
  ...
  var _useState5 = useState(getLabelFromValue(value)),
  ...
  var _useState9 = useState(id || "jkl-select-".concat(nanoid(8))),
  ...
  return /*#__PURE__*/React.createElement("div", _extends({
  ...
  }, selectProps), /*#__PURE__*/React.createElement(Label, {
    variant: variant,
    ...
    onBlur: handleBlur,
    onFocus: handleFocus
  }, hasSelectedValue ? displayedValue : defaultPrompt), /*#__PURE__*/React.createElement(CoreToggle, {
    id: listId,
    ref: elementRef,
    role: "listbox",
    ...
    tabIndex: -1,
    ref: listRef
  }, items.map(getValuePair).map(function (item, i) {
  ...
  }))), /*#__PURE__*/React.createElement(ExpandArrow, {
...
var NativeSelect = /*#__PURE__*/forwardRef(function (_ref, ref) {
  var id = _ref.id,
      label = _ref.label,
      items = _ref.items,
  ...
  var _useState = useState(id || "jkl-select-".concat(nanoid(8))),
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    onFocus: onFocus
  }, placeholder && !value && /*#__PURE__*/React.createElement("option", {
    disabled: true,
    value: ""
