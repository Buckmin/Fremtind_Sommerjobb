...
var TextArea = React.forwardRef(function (_ref, ref) {
  ...
  var _useState = React.useState(id || "jkl-text-area-".concat(nanoid(8))),
  ...
  }, label), /*#__PURE__*/React__default.createElement("textarea", _extends({
    id: uid,
    ref: textAreaRef,
  ...
  }, restProps)), /*#__PURE__*/React__default.createElement(jklCore.SupportLabel, {
    inverted: inverted,
    id: supportId,
    helpLabel: helpLabel,
...
var BaseInputField = React.forwardRef(function (_ref, ref) {
  var id = _ref.id,
...
var TextInput = React.forwardRef(function (_ref, ref) {
  ...
  var _useState = React.useState(id || "jkl-text-input-".concat(nanoid(8))),
      _useState2 = _slicedToArray(_useState, 1),
      uid = _useState2[0];
  ...
  }, /*#__PURE__*/React__default.createElement(BaseInputField, _extends({
    ref: ref,
    id: uid,
    describedBy: describedBy,
    invalid: !!errorLabel
  }, inputProps)), action && /*#__PURE__*/React__default.createElement(jklIconButtonReact.IconButton, {
